...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'CountryPreference', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('school', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cms.School'])),
            ('country', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cms.Country'])),
            ('rank', self.gf('django.db.models.fields.IntegerField')(default=1, db_column='rank')),
        ))
        db.send_create_signal('cms', ['CountryPreference'])
        ...
        db.create_table(u'Delegate', (
            ...
            ('delegateslot', self.gf('django.db.models.fields.related.OneToOneField')(default=None, related_name='delegate', unique=True, null=True, to=orm['cms.DelegateSlot'])),
        ))
        ...
        db.create_table(u'UserProfile', (
            ...
            ('school', self.gf('django.db.models.fields.related.ForeignKey')(related_name='advisor', to=orm['cms.School'])),
        ...
        db.create_table(u'AdvisorProfile', (
            ...
            ('school', self.gf('django.db.models.fields.related.ForeignKey')(related_name='advisor_profile', to=orm['cms.School'])),
        ))
        db.send_create_signal('cms', ['AdvisorProfile'])
        ...
        db.create_table(u'SecretariatProfile', (
            ...
            ('committee', self.gf('django.db.models.fields.related.ForeignKey')(related_name='secretariat_profile', to=orm['cms.Committee'])),
        ...
        db.send_create_signal('cms', ['SecretariatProfile'])
    ...
    models = {
        ...
        'cms.advisorprofile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'school': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'advisor_profile'", 'to': "orm['cms.School']"}),
        ...
        'cms.secretariatprofile': {
            'Meta': {'object_name': 'SecretariatProfile', 'db_table': "u'SecretariatProfile'"},
            'committee': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'secretariat_profile'", 'to': "orm['cms.Committee']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
