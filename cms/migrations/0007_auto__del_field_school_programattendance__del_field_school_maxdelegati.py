...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'School.programattendance'
        db.delete_column(u'School', 'ProgramAttendance')

        # Deleting field 'School.maxdelegation'
        db.delete_column(u'School', 'MaximumDelegation')

        # Deleting field 'School.mindelegation'
        db.delete_column(u'School', 'MinimumDelegation')

        # Deleting field 'School.schoolzip'
        db.delete_column(u'School', 'SchoolZip')

        # Adding field 'School.zip'
        db.add_column(u'School', 'zip', self.gf('django.db.models.fields.CharField')(default='', max_length=765, db_column='SchoolZip', blank=True), keep_default=False)

        # Adding field 'School.timesattended'
        db.add_column(u'School', 'timesattended', self.gf('django.db.models.fields.IntegerField')(default=0, db_column='TimesAttended'), keep_default=False)

        # Adding field 'School.mindelegationsize'
        db.add_column(u'School', 'mindelegationsize', self.gf('django.db.models.fields.IntegerField')(default=0, db_column='MinimumDelegationSize'), keep_default=False)

        # Adding field 'School.maxdelegationsize'
        db.add_column(u'School', 'maxdelegationsize', self.gf('django.db.models.fields.IntegerField')(default=0, db_column='MaximumDelegationSize'), keep_default=False)

        # Changing field 'School.dateregistered'
        db.alter_column(u'School', 'DateRegistered', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.date(2011, 9, 4), db_column='DateRegistered'))


    def backwards(self, orm):
        
        # Adding field 'School.programattendance'
        db.add_column(u'School', 'programattendance', self.gf('django.db.models.fields.IntegerField')(default=0, db_column='ProgramAttendance'), keep_default=False)

        # Adding field 'School.maxdelegation'
        db.add_column(u'School', 'maxdelegation', self.gf('django.db.models.fields.IntegerField')(default=0, db_column='MaximumDelegation'), keep_default=False)

        # Adding field 'School.mindelegation'
        db.add_column(u'School', 'mindelegation', self.gf('django.db.models.fields.IntegerField')(default=0, db_column='MinimumDelegation'), keep_default=False)

        # Adding field 'School.schoolzip'
        db.add_column(u'School', 'schoolzip', self.gf('django.db.models.fields.CharField')(default='', max_length=765, db_column='SchoolZip', blank=True), keep_default=False)

        # Deleting field 'School.zip'
        db.delete_column(u'School', 'SchoolZip')

        # Deleting field 'School.timesattended'
        db.delete_column(u'School', 'TimesAttended')

        # Deleting field 'School.mindelegationsize'
        db.delete_column(u'School', 'MinimumDelegationSize')

        # Deleting field 'School.maxdelegationsize'
        db.delete_column(u'School', 'MaximumDelegationSize')

        # Changing field 'School.dateregistered'
        db.alter_column(u'School', 'DateRegistered', self.gf('django.db.models.fields.DateTimeField')(null=True, db_column='DateRegistered'))
