...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Committee.delegatesperdelegation'
        db.add_column(u'Committee', 'delegatesperdelegation', self.gf('django.db.models.fields.IntegerField')(default=2, db_column='delegatesperdelegation'), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Committee.delegatesperdelegation'
        db.delete_column(u'Committee', 'delegatesperdelegation')
