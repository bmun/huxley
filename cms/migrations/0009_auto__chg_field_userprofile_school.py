...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'UserProfile', 'school_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cms.School']))


    def backwards(self, orm):
        
        # Changing field 'UserProfile.school'
        db.alter_column(u'UserProfile', 'school_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cms.Schools']))
