...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Delegate.committee'
        db.delete_column(u'Delegate', 'Committee')

        # Deleting field 'Delegate.schoolid'
        db.delete_column(u'Delegate', 'SchoolID')

        # Deleting field 'Delegate.country'
        db.delete_column(u'Delegate', 'Country')


    def backwards(self, orm):
        
        # Adding field 'Delegate.committee'
        db.add_column(u'Delegate', 'committee', self.gf('django.db.models.fields.CharField')(default='', max_length=765, db_column='Committee', blank=True), keep_default=False)

        # Adding field 'Delegate.schoolid'
        db.add_column(u'Delegate', 'schoolid', self.gf('django.db.models.fields.IntegerField')(null=True, db_column='SchoolID'), keep_default=False)

        # Adding field 'Delegate.country'
        db.add_column(u'Delegate', 'country', self.gf('django.db.models.fields.CharField')(default='', max_length=765, db_column='Country', blank=True), keep_default=False)
