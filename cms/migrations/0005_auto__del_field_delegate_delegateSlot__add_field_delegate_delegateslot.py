...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Delegate.delegateSlot'
        db.delete_column(u'Delegate', 'delegateSlot_id')

        # Adding field 'Delegate.delegateslot'
        db.add_column(u'Delegate', 'delegateslot', self.gf('django.db.models.fields.related.OneToOneField')(default=None, related_name='delegate', unique=True, null=True, to=orm['cms.DelegateSlot']), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Delegate.delegateSlot'
        db.add_column(u'Delegate', 'delegateSlot', self.gf('django.db.models.fields.related.OneToOneField')(default=None, related_name='slot', unique=True, to=orm['cms.DelegateSlot']), keep_default=False)
