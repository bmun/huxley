...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Committee.special'
        db.add_column(u'Committee', 'special', self.gf('django.db.models.fields.BooleanField')(default=False, db_column='special'), keep_default=False)

        # Adding M2M table for field countrypreferences on 'School'
        db.create_table(u'School_countrypreferences', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('school', models.ForeignKey(orm['cms.school'], null=False)),
            ('country', models.ForeignKey(orm['cms.country'], null=False))
        ))
        db.create_unique(u'School_countrypreferences', ['school_id', 'country_id'])

        # Adding M2M table for field committeepreferences on 'School'
        db.create_table(u'School_committeepreferences', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('school', models.ForeignKey(orm['cms.school'], null=False)),
            ('committee', models.ForeignKey(orm['cms.committee'], null=False))
        ))
        db.create_unique(u'School_committeepreferences', ['school_id', 'committee_id'])

        # Adding field 'Country.special'
        db.add_column(u'Country', 'special', self.gf('django.db.models.fields.BooleanField')(default=False, db_column='special'), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Committee.special'
        db.delete_column(u'Committee', 'special')

        # Removing M2M table for field countrypreferences on 'School'
        db.delete_table('School_countrypreferences')

        # Removing M2M table for field committeepreferences on 'School'
        db.delete_table('School_committeepreferences')

        # Deleting field 'Country.special'
        db.delete_column(u'Country', 'special')
    ...
    models = {
        ...
        'cms.school': {
            ...
            'committeepreferences': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['cms.Committee']", 'db_column': "'CommitteePreferences'", 'symmetrical': 'False'}),
            'countrypreferences': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['cms.Country']", 'db_column': "'CountryPreferences'", 'symmetrical': 'False'}),
