...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Committee.fullname'
        db.add_column(u'Committee', 'fullname', self.gf('django.db.models.fields.CharField')(default='', max_length=765, db_column='fullname', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Committee.fullname'
        db.delete_column(u'Committee', 'fullname')
