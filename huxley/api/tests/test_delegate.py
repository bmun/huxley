...
class DelegateDetailPutTestCase(tests.UpdateAPITestCase):
    ...
    def test_advisor(self):
        ...
        self.assertEqual(response.data, {
            ...
            "summary": str(self.params['summary']),
            "published_summary": str(self.params['published_summary']),
        ...
        for i in range(len(response.data)):
            self.assertEqual(
                dict(response.data[i]), {
                    ...
                    'name': str(delegates[i].name),
                    'email': str(delegates[i].email),
                    'summary': str(delegates[i].summary),
                    'published_summary':
                    str(delegates[i].published_summary),
    ...
    def test_chair(self):
        ...
        self.assertEqual(
            dict(response.data[1]),
            {
                ...
                'name': str(self.delegate3.name),
                'email': str(self.delegate3.email),
                'summary': str(self.delegate3.summary),
                'published_summary': str(self.delegate3.published_summary),
