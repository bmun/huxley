...
describe('CommitteeFeedbackStore', () => {
  ...
  beforeEach(() => {
    ...
    ServerAPI.getCommitteeFeedback.mockReturnValue(
      Promise.resolve(mockFeedbacks),
    );
  ...
  it('differentiates no feedback from not having fetched feedback', () => {
    var feedback = CommitteeFeedbackStore.getCommitteeFeedback(
      noFeedbackCommitteeID,
    );
    expect(feedback.length).toEqual(0);
    expect(ServerAPI.getCommitteeFeedback).toBeCalledWith(
      noFeedbackCommitteeID,
    );
    ...
    feedback = CommitteeFeedbackStore.getCommitteeFeedback(
      noFeedbackCommitteeID,
    );
