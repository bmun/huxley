    ...
    $.ajax({
      ...
      data: JSON.stringify({
        ...
        school: {
          ...
          intermediate_delegates: this.state.intermediate_delegates.trim(),
          advanced_delegates: this.state.advanced_delegates.trim(),
          spanish_speaking_delegates: this.state.spanish_speaking_delegates.trim(),
