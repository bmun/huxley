...
class CommitteeFeedbackAdmin(admin.ModelAdmin):
    ...
    def list(self, request):
        ...
        feedbacks['Content-Disposition'] = 'attachment; filename="feedback.csv"'
        ...
        for feedback in CommitteeFeedback.objects.all().order_by('committee__name'):
            writer.writerow([
                feedback.committee.name,
                feedback.rating,
                feedback.comment,
                feedback.chair_1_name,
                feedback.chair_1_rating,
                feedback.chair_1_comment,
                feedback.chair_2_name,
                feedback.chair_2_rating,
                feedback.chair_2_comment,
                feedback.chair_3_name,
                feedback.chair_3_rating,
                feedback.chair_3_comment,
                feedback.chair_4_name,
                feedback.chair_4_rating,
                feedback.chair_4_comment,
                feedback.chair_5_name,
                feedback.chair_5_rating,
                feedback.chair_5_comment,
                feedback.chair_6_name,
                feedback.chair_6_rating,
                feedback.chair_6_comment,
                feedback.chair_7_name,
                feedback.chair_7_rating,
                feedback.chair_7_comment,
                feedback.chair_8_name,
                feedback.chair_8_rating,
                feedback.chair_8_comment,
