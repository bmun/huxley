...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'School.delegation_size'
        db.delete_column(u'school', 'delegation_size')

        # Adding field 'School.beginner_delegates'
        db.add_column(u'school', 'beginner_delegates',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'School.intermediate_delegates'
        db.add_column(u'school', 'intermediate_delegates',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'School.advanced_delegates'
        db.add_column(u'school', 'advanced_delegates',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'School.spanish_speaking_delegates'
        db.add_column(u'school', 'spanish_speaking_delegates',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)


        # Changing field 'School.registration_comments'
        db.alter_column(u'school', 'registration_comments', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):
        # Adding field 'School.delegation_size'
        db.add_column(u'school', 'delegation_size',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'School.beginner_delegates'
        db.delete_column(u'school', 'beginner_delegates')

        # Deleting field 'School.intermediate_delegates'
        db.delete_column(u'school', 'intermediate_delegates')

        # Deleting field 'School.advanced_delegates'
        db.delete_column(u'school', 'advanced_delegates')

        # Deleting field 'School.spanish_speaking_delegates'
        db.delete_column(u'school', 'spanish_speaking_delegates')


        # Changing field 'School.registration_comments'
        db.alter_column(u'school', 'registration_comments', self.gf('django.db.models.fields.TextField')(null=True))
