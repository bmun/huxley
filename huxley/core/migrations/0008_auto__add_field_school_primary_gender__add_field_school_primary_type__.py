...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'School.primary_gender'
        db.add_column(u'school', 'primary_gender',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1),
                      keep_default=False)

        # Adding field 'School.primary_type'
        db.add_column(u'school', 'primary_type',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=2),
                      keep_default=False)

        # Adding field 'School.secondary_gender'
        db.add_column(u'school', 'secondary_gender',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1),
                      keep_default=False)

        # Adding field 'School.secondary_type'
        db.add_column(u'school', 'secondary_type',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'School.primary_gender'
        db.delete_column(u'school', 'primary_gender')

        # Deleting field 'School.primary_type'
        db.delete_column(u'school', 'primary_type')

        # Deleting field 'School.secondary_gender'
        db.delete_column(u'school', 'secondary_gender')

        # Deleting field 'School.secondary_type'
        db.delete_column(u'school', 'secondary_type')
    ...
    models = {
        ...
        u'core.school': {
            ...
            'delegation_size': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '0'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'international': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
            'primary_email': ('django.db.models.fields.EmailField', [], {'max_length': '75'}),
            'primary_gender': ('django.db.models.fields.PositiveSmallIntegerField', [], {}),
            ...
            'primary_type': ('django.db.models.fields.PositiveSmallIntegerField', [], {}),
            ...
            'secondary_gender': ('django.db.models.fields.PositiveSmallIntegerField', [], {}),
            ...
            'secondary_type': ('django.db.models.fields.PositiveSmallIntegerField', [], {}),
