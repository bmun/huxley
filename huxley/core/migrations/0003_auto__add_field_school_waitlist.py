...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'School.waitlist'
        db.add_column(u'school', 'waitlist',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'School.waitlist'
        db.delete_column(u'school', 'waitlist')
    ...
    models = {
        ...
        u'core.school': {
            ...
            'waitlist': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
