...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Conference.open_reg'
        db.add_column(u'conference', 'open_reg',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Conference.waitlist_reg'
        db.add_column(u'conference', 'waitlist_reg',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Conference.open_reg'
        db.delete_column(u'conference', 'open_reg')

        # Deleting field 'Conference.waitlist_reg'
        db.delete_column(u'conference', 'waitlist_reg')
