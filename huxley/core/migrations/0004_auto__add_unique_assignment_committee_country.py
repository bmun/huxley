...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Assignment', fields ['committee', 'country']
        db.create_unique(u'assignment', ['committee_id', 'country_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Assignment', fields ['committee', 'country']
        db.delete_unique(u'assignment', ['committee_id', 'country_id'])
