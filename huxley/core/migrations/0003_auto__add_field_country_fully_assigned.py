...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Country.fully_assigned'
        db.add_column(u'country', 'fully_assigned',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Country.fully_assigned'
        db.delete_column(u'country', 'fully_assigned')
    ...
    models = {
        ...
        u'core.country': {
            ...
            'fully_assigned': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
