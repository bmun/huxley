...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'Conference', (
            ...
            ('session', self.gf('django.db.models.fields.IntegerField')(default=0, db_column='Session')),
            ('startdate', self.gf('django.db.models.fields.DateField')(db_column='StartDate')),
            ('enddate', self.gf('django.db.models.fields.DateField')(db_column='EndDate')),
            ...
            ('minattendance', self.gf('django.db.models.fields.IntegerField')(default=0, db_column='MinAttendance')),
            ('maxattendance', self.gf('django.db.models.fields.IntegerField')(default=0, db_column='MaxAttendance')),
        ))
