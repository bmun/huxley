...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'School.registration_comments'
        db.add_column(u'school', 'registration_comments',
                      self.gf('django.db.models.fields.TextField')(default='', null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'School.registration_comments'
        db.delete_column(u'school', 'registration_comments')
    ...
    models = {
        ...
        u'core.school': {
            ...
            'registration_comments': ('django.db.models.fields.TextField', [], {'default': "''", 'null': 'True'}),
