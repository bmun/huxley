...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'School.min_delegation_size'
        db.delete_column(u'school', 'min_delegation_size')

        # Deleting field 'School.max_delegation_size'
        db.delete_column(u'school', 'max_delegation_size')
    ...
    def backwards(self, orm):
        # Adding field 'School.min_delegation_size'
        db.add_column(u'school', 'min_delegation_size',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'School.max_delegation_size'
        db.add_column(u'school', 'max_delegation_size',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)
