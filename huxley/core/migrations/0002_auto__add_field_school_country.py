...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'school', 'country',
                      self.gf('django.db.models.fields.CharField')(default='United States of America', max_length=64),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'School.country'
        db.delete_column(u'school', 'country')
