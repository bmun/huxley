...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'CountryPreference', fields ['school', 'country']
        db.delete_unique(u'country_preference', ['school_id', 'country_id'])

        # Adding unique constraint on 'CountryPreference', fields ['country', 'school']
        db.create_unique(u'country_preference', ['country_id', 'school_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'CountryPreference', fields ['country', 'school']
        db.delete_unique(u'country_preference', ['country_id', 'school_id'])

        # Adding unique constraint on 'CountryPreference', fields ['school', 'country']
        db.create_unique(u'country_preference', ['school_id', 'country_id'])
    ...
    models = {
        ...
        u'core.countrypreference': {
            'Meta': {'ordering': "['-school', 'rank']", 'unique_together': "(('country', 'school'),)", 'object_name': 'CountryPreference', 'db_table': "u'country_preference'"},
            'country': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Country']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
