...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'School.registration_fee_paid'
        db.delete_column(u'school', 'registration_fee_paid')

        # Deleting field 'School.delegation_fee'
        db.delete_column(u'school', 'delegation_fee')

        # Deleting field 'School.delegation_fee_paid'
        db.delete_column(u'school', 'delegation_fee_paid')

        # Deleting field 'School.registration_fee'
        db.delete_column(u'school', 'registration_fee')

        # Deleting field 'School.registration_fee_balance'
        db.delete_column(u'school', 'registration_fee_balance')

        # Deleting field 'School.delegation_fee_balance'
        db.delete_column(u'school', 'delegation_fee_balance')

        # Adding field 'School.fees_owed'
        db.add_column(u'school', 'fees_owed',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=6, decimal_places=2),
                      keep_default=False)

        # Adding field 'School.fees_paid'
        db.add_column(u'school', 'fees_paid',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=6, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'School.registration_fee_paid'
        db.add_column(u'school', 'registration_fee_paid',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=6, decimal_places=2),
                      keep_default=False)

        # Adding field 'School.delegation_fee'
        db.add_column(u'school', 'delegation_fee',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=6, decimal_places=2),
                      keep_default=False)

        # Adding field 'School.delegation_fee_paid'
        db.add_column(u'school', 'delegation_fee_paid',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=6, decimal_places=2),
                      keep_default=False)

        # Adding field 'School.registration_fee'
        db.add_column(u'school', 'registration_fee',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=6, decimal_places=2),
                      keep_default=False)

        # Adding field 'School.registration_fee_balance'
        db.add_column(u'school', 'registration_fee_balance',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=6, decimal_places=2),
                      keep_default=False)

        # Adding field 'School.delegation_fee_balance'
        db.add_column(u'school', 'delegation_fee_balance',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=6, decimal_places=2),
                      keep_default=False)

        # Deleting field 'School.fees_owed'
        db.delete_column(u'school', 'fees_owed')

        # Deleting field 'School.fees_paid'
        db.delete_column(u'school', 'fees_paid')
