...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Delegate.session4'
        db.delete_column(u'Delegate', 'session4')

        # Deleting field 'Delegate.session2'
        db.delete_column(u'Delegate', 'session2')

        # Deleting field 'Delegate.session1'
        db.delete_column(u'Delegate', 'session1')

        # Deleting field 'Delegate.session3'
        db.delete_column(u'Delegate', 'session3')

        # Adding field 'DelegateSlot.attended_session1'
        db.add_column(u'DelegateSlot', 'attended_session1',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'DelegateSlot.attended_session2'
        db.add_column(u'DelegateSlot', 'attended_session2',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'DelegateSlot.attended_session3'
        db.add_column(u'DelegateSlot', 'attended_session3',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'DelegateSlot.attended_session4'
        db.add_column(u'DelegateSlot', 'attended_session4',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Delegate.session4'
        db.add_column(u'Delegate', 'session4',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Delegate.session2'
        db.add_column(u'Delegate', 'session2',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Delegate.session1'
        db.add_column(u'Delegate', 'session1',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Delegate.session3'
        db.add_column(u'Delegate', 'session3',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'DelegateSlot.attended_session1'
        db.delete_column(u'DelegateSlot', 'attended_session1')

        # Deleting field 'DelegateSlot.attended_session2'
        db.delete_column(u'DelegateSlot', 'attended_session2')

        # Deleting field 'DelegateSlot.attended_session3'
        db.delete_column(u'DelegateSlot', 'attended_session3')

        # Deleting field 'DelegateSlot.attended_session4'
        db.delete_column(u'DelegateSlot', 'attended_session4')
